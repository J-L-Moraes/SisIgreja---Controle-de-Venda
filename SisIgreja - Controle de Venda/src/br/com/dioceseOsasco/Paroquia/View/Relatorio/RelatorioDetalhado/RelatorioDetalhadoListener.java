...
public class RelatorioDetalhadoListener implements ActionListener {
	
	FrmRelatorioDetalhado frm;
	
	public RelatorioDetalhadoListener(FrmRelatorioDetalhado frm){
		this.frm = frm;
		adicionaListener();	
	}
	...
	public void actionPerformed(ActionEvent event) {
		...
		case "Visualizar Relat\u00F3rio":
			...
			if (frm.chckbxTodosOsEventos.isSelected()) {
				JasperPrint jasperPrint = gerarRelatorio("RelatorioDetalhado.jasper");
				if (jasperPrint != null) {
					frm.dispose();
					...
					viewer.setTitle("Relatório Detalhado de Venda (Todas os Eventos)");
				...
				JasperPrint jasperPrint = gerarRelatorio("RelatorioDetalhado.jasper", data);
				if (jasperPrint != null) {
					frm.dispose();
					...
					viewer.setExtendedState(JasperViewer.MAXIMIZED_BOTH);
					 //setando um titulo p/ o relatório  
					viewer.setTitle("Relatório Detalhado de Venda");
				}
			}
	...
	private JasperPrint gerarRelatorio(String nomeRelatorio){
		...
		CollectionTbItem = relatorioDAO.RelatorioVendaDetalhado();
	...
	private JasperPrint gerarRelatorio(String nomeRelatorio, Date data){
		...
		Collection<TbItem> CollectionTbItem = new LinkedList<TbItem>();
		RelatorioDAO relatorioDAO = new RelatorioDAO();
		CollectionTbItem = relatorioDAO.RelatorioVendaDetalhado(data);
