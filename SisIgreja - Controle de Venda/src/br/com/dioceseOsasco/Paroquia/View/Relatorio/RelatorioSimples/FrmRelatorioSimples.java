...
public class FrmRelatorioSimples extends JDialog {
	...
	public FrmRelatorioSimples(){
		Interface();
		new RelatorioSimplesListener(this);
	}

	private void Interface() {

		setTitle("SisIgreja - Gerador de Relat\u00F3rio Simples");
		setIconImage(Toolkit.getDefaultToolkit().getImage(FrmRelatorioSimples.class.getResource("/br/com/dioceseOsasco/Paroquia/View/img/IconeSistema.png")));
		...
		btnSalvarRelatorio.setIcon(new ImageIcon(FrmRelatorioSimples.class.getResource("/br/com/dioceseOsasco/Paroquia/View/img/Relatorio/Relatorio1(24x24).png")));
		btnSalvarRelatorio.setBounds(171, 139, 137, 29);
		getContentPane().add(btnSalvarRelatorio);
		
		btnCancelar = new JButton("Cancelar");
		btnCancelar.setIcon(new ImageIcon(FrmRelatorioSimples.class.getResource("/br/com/dioceseOsasco/Paroquia/View/img/CancelarRemover.png")));
		...
		btnVisualizar.setIcon(new ImageIcon(FrmRelatorioSimples.class.getResource("/br/com/dioceseOsasco/Paroquia/View/img/Relatorio/VisualizarRelatorio(24x24).png")));
