...
public class JCalendar extends JComboBox {
  ...
  private class SubstanceDateComboBoxUI extends SubstanceComboBoxUI {

		public SubstanceDateComboBoxUI(JComboBox combo) {
		super(combo);
  ...
  /**
   * Responsavel pelo Interface do ComboBox
   * UIManager.getUI(JCalendar.this);
   */
  @Override
  public void updateUI() {
    ...
    if (comboBoxUI instanceof MetalComboBoxUI) {
      ...
      comboBoxUI = new SynthDateComboBoxUI();
    	...
    	comboBoxUI = new SubstanceDateComboBoxUI(new JComboBox());
    }
